...
- Table Names could be argued to be named singular, not plural. 
  
  However, using inheritance and an ORM could make one lean towards plural. 
  
  Whatever choice is made, make it based on internal needs and facts and reasons.
  
  Table Names should provide a clear, concise description of the entity the table contains.
